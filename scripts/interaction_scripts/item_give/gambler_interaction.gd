...
func _input(event):
	if event.is_action_pressed("interact") and interaction_times == 0 and message_displayed and interact and Input.is_action_just_pressed("interact") and Transition.canvas_layer.visible == false and Inventory.inventory_layer.visible == false:
